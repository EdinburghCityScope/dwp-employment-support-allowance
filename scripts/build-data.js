...
const csvFilename = 'employment-support-allowance.csv';
...
PREFIX qb: <http://purl.org/linked-data/cube#>
            ...
            SELECT ?period ?zone ?age ?gender ?ethnicity ?benefit ?measure ?value
            WHERE {
                ?s qb:dataSet data:employment-support-allowance ;
                   qb:measureType ?m ;
                   ?m ?value ;
                   dim:gender ?g ;
                   dim:age ?a ;
                   dim:ethnicity ?e ;
                   dim:benefitClaimed ?b ;
                   ldim:refArea ?z ;
                   ldim:refPeriod ?p .
                ?g rdfs:label ?gender .
                ?z rdfs:label ?zone .
                ?b rdfs:label ?benefit .
